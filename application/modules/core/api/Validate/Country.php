...
class Core_Api_Validate_Country extends Zend_Validate_Abstract {
    const NOT_COUNTRY = 'notCountry';

    protected $_messageTemplates = array(
        self::NOT_COUNTRY => 'The value you entered does not match a valid country name.'
    );
    ...
    public function isValid($value, $context = null) {
        ...
        if(!isset(self::$_countries[$value])){
        	$this->_error(self::NOT_COUNTRY);
        	$error = true;
        }
        return !$error;
    }
