 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_Api_View_Helper_FormButton extends Zend_View_Helper_FormButton
{
    /**
     * Generates a 'button' element with the label text wrapped by a span for offsetting the text via css.
     *
     * @access public
     *
    ...
    public function formButton($name, $value = null, $attribs = null)
    {
        ...
        // add content and end tag (wrap it in a span for offsetting text for buttons with background images)
